	...
	<div class="logo_products">
		...
		<div class="w3ls_logo_products_left1">
				<ul class="phone_email">
					<li><i class="fa fa-phone" aria-hidden="true"></i>Hubungi Kami : (+6282) 3856 7032</li>
				</ul>
			</div>
			<div class="w3ls_logo_products_left">
				<h1><a href="index.php">UZY Food</a></h1>
			</div>
...
<!-- checkout -->
	<div class="checkout">
		<div class="container">
			<h1>Terima kasih, <?=$_SESSION['name']?> telah membeli <?php echo $itungtrans3 ?> Makanan di UZY Food</span></h1>
			...
			<hr>
			<br><center>
			<h2>Total harga yang tertera di atas sudah termasuk ongkos kirim sebesar Rp15.000</h2>
		...
		<br>
		<form method="post">
		<input type="submit" class="form-control btn btn-success" name="checkout" value="SETUJU DAN BAYAR" \>
		</form>
...
<div class="footer">
		<div class="container">
			<div class="w3_footer_grids">
				<div class="col-md-4 w3_footer_grid">
					...
					<ul class="address">
					<li><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i>UZY Food, Kota Mataram.</li>
						<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a href="mailto:info@email">uzy.food@gmail.com</a></li>
						<li><i class="glyphicon glyphicon-earphone" aria-hidden="true"></i>+62 852 3856 7032</li>
					</ul>
				</div>
				<div class="col-md-3 w3_footer_grid">
					<h3>Tentang Kami</h3>
					<ul class="info"> 
					<li><i class="fa fa-arrow-right" aria-hidden="true"></i><a href="about.html">Tentang Toko</a></li>
						<li><i class="fa fa-arrow-right" aria-hidden="true"></i><a href="aboutme.html">Tentang Kami</a></li>
		...
		<div class="footer-copy">
			...
			<div class="container">
				<p>© 2022 UZY Food. All rights reserved</p>
			</div>
		</div>
